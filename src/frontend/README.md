...
│   └── components/
│       ├── SquatAnalyzer.jsx   # MediaPipe squat analyzer orchestrator
│       ├── Skeleton3DViewer.jsx  # 3-D replay canvas for squat sessions
│       ├── squatAnalyzerUtils.js # Shared MediaPipe helpers/constants
