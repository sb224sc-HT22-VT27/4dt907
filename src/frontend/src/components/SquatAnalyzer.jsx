...
// Landmark set aligned with the normalized Kinect A11 CSV files
// (kinect_good_preprocessed_not_cut_A11_mediapipe) so both data sources
// share a common set of named joints.
